...
// // const GENERATE_SUBTASKS = "Generate Subtasks";
// // const CREATE_PLAN = "Create Plan";

// // // Add nodes to the graph
// // workflow.addNode(GENERATE_SUBTASKS, generateSubtasks);
// // workflow.addNode(CREATE_PLAN, createPlan);

// // // Define edges
// // workflow.addEdge(GENERATE_SUBTASKS, CREATE_PLAN);
// // workflow.addEdge(CREATE_PLAN, END);

// // Set the entry point
// workflow.addEdge(START, "Generate Subtasks");
